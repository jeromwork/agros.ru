<?php
    ...
    bender2_add_body_class('forgot');
    osc_current_web_theme_path('header.php');
?>
<div class="form-container form-horizontal form-container-box">
    <div class="header">
        <h1><?php _e('Recover your password', 'bender2'); ?></h1>
    </div>
    <div class="resp-wrapper">
        <form name="reset_password" id="reset_password" action="<?php echo osc_base_url(true); ?>" method="post" >
            ...
            <div class="control-group">
                <div class="controls">
                    <button type="submit" class="ui-button ui-button-middle ui-button-main"><?php _e("Change password", 'bender2');?></button>
                </div>
            </div>
        </form>
    </div>
