...
$(document).ready(function() {
    ...
    function() {
        $("#navigation-view").val("view1").on("change", function(e) {
            e = $(this).val(),
            $(".pcoded").attr("vnavigation-view", e)
        })
    }(),
    function() {
    ...
    function() {
        $("#vertical-activeitem-style").val("style1").on("change", function(e) {
            e = $(this).val(),
            $(".pcoded-navbar").attr("active-item-style", e)
        })
    }(),
    function() {
    ...
    $('#' + "pcoded").attr("vertical-nav-type", "offcanvas");//костыль что бы скрывалось меню при загрузке страницы
