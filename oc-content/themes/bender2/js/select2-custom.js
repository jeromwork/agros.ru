...
//--Что бы не лезть в формирование форм в файлах РНР сделаем пост формирование на жавике.
//но обязательно сверху этого файла, снизу нельзя, сработает неправильно.
$(document).ready(function(){
    $("#catId").addClass("js-example-basic-single");
});
...
console.log(child.text);
  ...
  $(".js-example-basic-single").select2({
    matcher: matchStart,
    "language": {
        "noResults": function(){            return "Результаты не найдены. Попробуйте выбрать вручную.";  }
    },
