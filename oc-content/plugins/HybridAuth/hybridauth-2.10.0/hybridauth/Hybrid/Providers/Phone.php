...
/*
  Phone.lv is the most popular social network in Latvia with 1200 000+ registered users and 650 000 unique hits per month.

  Phone.lv Passport documentation at:
  http://www.frype.com/applications/dev/docs/passport_en/
*/
class Hybrid_Providers_Phone extends Hybrid_Provider_Model
{ 
	public $user_id;
